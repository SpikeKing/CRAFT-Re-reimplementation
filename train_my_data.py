...
from data_loader import Synth80k, MyDataset
from eval.script import getresult
###import file#######
from mseloss import Maploss
from root_dir import SYNTH_TEXT_PATH, DATA_DIR, MY_DATASET
...
if __name__ == '__main__':
    ...
    if is_cpu:
        net.load_state_dict(copyStateDict(torch.load(weak_model_path, map_location=torch.device('cpu'))))
    else:
